	...
	var integrate = function() {
		...
		*/
		ARController.prototype.createThreeScene = function(video) {
			...
			// var videoCamera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 100, 1000000);
			...
			var camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 10000, 10000);
