(function () {
  ...
  header.innerHTML = '<a class="header-home" href="index.html">← Übersicht</a><div><span class="eyebrow">Forschungsstation</span><h1>' + station.title + '</h1><p>' + station.subtitle + '</p></div><span class="tempus-badge">Professor Tempus Zeitarchiv</span>';
